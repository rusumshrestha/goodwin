...
?>
	...
	<?php elseif ( is_search() ) : ?>
		...
		<div class="loop-meta">
			...
			<div class="loop-description">
				<p>
				<?php printf( __( 'You are browsing the search results for "%s"', 'cascade' ), esc_attr( get_search_query() ) ); ?>
				</p>
			</div><!-- .loop-description -->
	...
	<?php elseif ( is_date() ) : ?>
		...
		<div class="loop-meta">
			<h1 class="loop-title"><?php _e( 'Archives by date', 'cascade' ); ?></h1>

			<div class="loop-description">
				<p>
				<?php _e( 'You are browsing the site archives by date.', 'cascade' ); ?>
				</p>
			</div><!-- .loop-description -->
	...
	<?php elseif ( is_archive() ) : ?>
		...
		<div class="loop-meta">
			...
			<h1 class="loop-title"><?php _e( 'Archives', 'cascade' ); ?></h1>

			<div class="loop-description">
				<p>
				<?php _e( 'You are browsing the site archives.', 'cascade' ); ?>
				</p>
			</div><!-- .loop-description -->
